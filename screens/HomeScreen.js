...
import { getProucts } from '../ProductReducer';
...
const HomeScreen = () => {
    ...
    useEffect(() => {
        ...
        const fetchProduct = () => {
            services.map((service) => dispatch(getProucts(service)))
        }
        fetchProduct();
    }, [])
    // console.log(product)
    ...
    return (
        ...
        <ScrollView style={{ backgroundColor: '#f0f0f0', flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <Icon name="location-pin" size={30} color='#fd5c63' />
                <View style={{}}>
                ...
                <Pressable style={{ marginLeft: 'auto', marginRight: 7 }}>
                    <Image
                        ...
                        source={{
                            uri: 'https://lh3.googleusercontent.com/ogw/AGvuzYZ3bC_3b9O1sArRadTWr5wkkN3tihTGVpGn789Q=s32-c-mo'
                        }}
                    />
                </Pressable>
            </View>
