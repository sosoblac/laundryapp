...
const PickUpScreen = () => {
    ...
    const proceedToCart = () => {
        if (!selectedDate || !selectedTime || !delivery) {
            Alert.alert(
                'Empty or invalid', 'Please select all the fields',
                [
                    {
                        text: 'Cancel',
    ...
    return (
        <>
            <SafeAreaView>
                <Text style={{ fontSize: 15, fontWeight: '500', marginHorizontal: 10 }}>enter Address</Text>
                <TextInput
                    style={{
                        padding: 40,
                        borderColor: 'gray',
                ...
                <Text style={{ fontSize: 15, fontWeight: '500', marginHorizontal: 10 }}>Pick Up Date</Text>
                ...
                <Text style={{ fontSize: 15, fontWeight: '500', marginHorizontal: 10 }}>Selected Time</Text>
                ...
                <Text style={{ fontSize: 15, fontWeight: '500', marginHorizontal: 10 }}>Delivery Date</Text>
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
